...
const generateProblems = (count = 30) => {
  ...
  for (let i = 0; i < count; i++) {
    ...
    if (b > a) [a, b] = [b, a] // ให้ a >= b
    problems.push({ a, b })
  }
  return problems
}

export default function SubPracticeExercise() {
  ...
  return (
    <div className="p-4">
      ...
      {/* 🔸 ส่วนที่พิมพ์ได้ */}
      <div id="print-area">
        <PrintHeader title="แบบฝึกหัดการลบเลขหลายหลัก (ป.2)" />
        ...
        <div className="flex flex-wrap gap-4 justify-center">
          {problems.map(({ a, b }, idx) => {
            ...
            const isCorrect = userAnswer === diff
